	...
	return (
		<div className="relative [perspective:800px]">
			...
			<motion.div
				...
				className="h-96 w-[32rem] absolute inset-0 rounded-xl shadow-lg p-2"
			>
				...
				<Image
					...
					alt="aceternity logo"
					fill
					className="object-cover object-left-top absolute rounded-lg border border-[#c4c4c4]/40 inset-0 h-full w-full"
				/>
			</motion.div>
		</div>
	);
